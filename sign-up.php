<?php
    ...
    if(isset($_POST['reg'])){
        ...
        if($res){
            $query = "INSERT INTO `users` (`name`, `surname`, `login`, `city`, `zip`, `password`) VALUES ('" . $name . "', '" . $surname . "', '" . $login . "', '" . $city ."', '" . $zip . "', '" . $pass . "');";
...
<form action="sign-up.php" method="post">
    ...
    <input type="text" placeholder="Ваш город..." name="city" required>
    <input type="text" placeholder="Почтовый индекс города" name="zip" required>
